...
#include "ensemble_phaser_test.hpp"

#include "../../domain/dsp/ensemble_phaser.hpp"
...
void EnsemblePhaserTest::test_process_disabled_shouldPassThrough()
{
    EnsemblePhaser phaser;
...
void EnsemblePhaserTest::test_process_enabled_shouldAlterSignal()
{
    EnsemblePhaser phaser;
    phaser.setSampleRate(SampleRate);
...
void EnsemblePhaserTest::test_process_enabled_shouldSweepOverTime()
{
...
void EnsemblePhaserTest::test_process_enabled_shouldSeparateChannels()
{
...
void EnsemblePhaserTest::test_process_maximumColor_shouldStayStable()
{
    EnsemblePhaser phaser;
    phaser.setSampleRate(SampleRate);
    phaser.setEnabled(true);
...
void EnsemblePhaserTest::test_reset_shouldClearState()
{
    EnsemblePhaser phaser;
    phaser.setSampleRate(SampleRate);
    phaser.setEnabled(true);
...
QTEST_GUILESS_MAIN(noteahead::EnsemblePhaserTest)
