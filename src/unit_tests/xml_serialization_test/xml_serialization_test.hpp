...
private slots:
    ...
    void test_toXmlFromXml_samplerDevice_padTuningTrimAndEnvelope_shouldRoundTrip();
    void test_toXmlFromXml_samplerDevice_padLoopAndChokeGroup_shouldRoundTrip();
