...
#ifndef STRING_VOICE_V3_TEST_HPP
#define STRING_VOICE_V3_TEST_HPP

#include <QObject>

namespace noteahead {

class StringVoiceV3Test : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void test_strings_withEnsembleOff_shouldStillBeModulated();
    void test_ensemble_shouldNotReachTheStrings();
    void test_strings_shouldShimmerRatherThanVibrate();
...
#endif // STRING_VOICE_V3_TEST_HPP
