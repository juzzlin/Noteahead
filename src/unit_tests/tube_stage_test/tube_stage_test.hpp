...
#ifndef TUBE_STAGE_TEST_HPP
#define TUBE_STAGE_TEST_HPP

#include <QObject>

namespace noteahead {

class TubeStageTest : public QObject
{
    Q_OBJECT

private slots:
    void test_mixZero_shouldPassSignalThrough();
    void test_triode_shouldGenerateEvenHarmonics();
    void test_pentode_centredBias_shouldFavourOddHarmonics();
    void test_bias_offCentre_shouldIncreaseEvenHarmonics();
    void test_output_shouldNotDriftToDc();
    void test_tone_shouldTiltTheSpectrum();
