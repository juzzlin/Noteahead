...
const std::vector<SynthPreset>& SynthPresets::presets()
{
    static const std::vector<SynthPreset> presetList = {
        ...
        {"Acid Line", {{"vco1waveform", 1}, {"lpfcutoff", 0.2}, {"lpfresonance", 0.8}, {"modtarget", 2}, {"modintensity", 0.7}, {"modattack", 0.0}, {"moddecay", 0.3}}},
        ...
        {"Wobble Lead", {{"vco1waveform", 1}, {"modtarget", 2}, {"modintensity", 0.5}, {"modattack", 0.2}, {"moddecay", 0.5}}},
        ...
        {"Ethereal", {{"vco1waveform", 0}, {"vco2waveform", 0}, {"vco2pitch", 12}, {"lpfcutoff", 0.3}, {"ampattack", 0.9}, {"delaytype", 5}, {"delaymix", 0.6}}},
        ...
        {"Pulse Keys", {{"vco1waveform", 2}, {"vco1shape", 0.3}, {"lpfcutoff", 0.5}}},
