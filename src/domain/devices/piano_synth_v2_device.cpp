...
std::vector<MidiCcController> PianoSynthV2Device::deviceMidiCcControllers() const
{
...
void PianoSynthV2Device::processDeviceMidiCc(uint8_t controller, uint8_t value, uint8_t)
{
    using namespace MidiCcMapping;
