...
std::vector<MidiCcController> PianoSynthV3Device::availableMidiCcControllers() const
{
...
void PianoSynthV3Device::processMidiCc(uint8_t controller, uint8_t value, uint8_t)
{
    using namespace MidiCcMapping;
