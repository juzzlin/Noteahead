...
#ifndef STRING_VOICE_V3_CONTROLLER_HPP
#define STRING_VOICE_V3_CONTROLLER_HPP
...
class StringVoiceV3Device;

class StringVoiceV3Controller : public DeviceController
{
    Q_OBJECT
...
public:
    explicit StringVoiceV3Controller(std::shared_ptr<StringVoiceV3Device> device, QObject * parent = nullptr);
    ~StringVoiceV3Controller() override;
...
public:
    void setDevice(std::shared_ptr<StringVoiceV3Device> device);

private:
    std::shared_ptr<StringVoiceV3Device> m_device;
};

} // namespace noteahead

#endif // STRING_VOICE_V3_CONTROLLER_HPP
