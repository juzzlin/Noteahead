...
#ifndef PIANO_SYNTH_V2_CONTROLLER_HPP
#define PIANO_SYNTH_V2_CONTROLLER_HPP
...
class PianoSynthV2Device;

class PianoSynthV2Controller : public DeviceController
{
    Q_OBJECT
...
public:
    explicit PianoSynthV2Controller(std::shared_ptr<PianoSynthV2Device> device, QObject * parent = nullptr);
    ~PianoSynthV2Controller() override;
...
public:
    void setDevice(std::shared_ptr<PianoSynthV2Device> device);

private:
    std::shared_ptr<PianoSynthV2Device> m_device;
};

} // namespace noteahead

#endif // PIANO_SYNTH_V2_CONTROLLER_HPP
