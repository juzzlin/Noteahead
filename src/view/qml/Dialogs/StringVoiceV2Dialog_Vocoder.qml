...
ColumnLayout {
    ...
    CheckBox {
        ...
        checked: stringVoiceV2Controller.vocoderEnabled
        onToggled: stringVoiceV2Controller.vocoderEnabled = checked
        Layout.fillWidth: true
    }

    RowLayout {
        Layout.fillWidth: true
        enabled: stringVoiceV2Controller.vocoderEnabled
        spacing: 10
        ...
        ComboBox {
            ...
            currentIndex: stringVoiceV2Controller.vocoderSidechain + 1
            onActivated: index => stringVoiceV2Controller.vocoderSidechain = index - 1
            Layout.fillWidth: true
        }
    }
}
