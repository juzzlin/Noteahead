...
AnimatedDialog {
    id: root
    title: applicationService.stringVoiceV2DeviceName
    modal: true
    focus: true
    ...
    onAboutToShow: () => {
        stringVoiceV2Controller.requestSettings();
    }
    ...
    footer: DialogButtonBox {
        ...
        onAccepted: () => {
            stringVoiceV2Controller.accept();
        }
        onRejected: () => {
            stringVoiceV2Controller.reject();
        }
    }
    ...
    ColumnLayout {
        ...
        VirtualKeyboard {
            Layout.fillWidth: true
            Layout.topMargin: 10
            onNoteOnRequested: note => stringVoiceV2Controller.playNote(note, UiService._activeVelocity / 127.0)
            onNoteOffRequested: note => stringVoiceV2Controller.stopNote(note)
        }
    }
}
