...
ColumnLayout {
    ...
    CheckBox {
        ...
        checked: stringVoiceV3Controller.vocoderEnabled
        onToggled: stringVoiceV3Controller.vocoderEnabled = checked
        Layout.fillWidth: true
    }

    RowLayout {
        Layout.fillWidth: true
        enabled: stringVoiceV3Controller.vocoderEnabled
        spacing: 10
        ...
        ComboBox {
            ...
            currentIndex: stringVoiceV3Controller.vocoderSidechain + 1
            onActivated: index => stringVoiceV3Controller.vocoderSidechain = index - 1
            Layout.fillWidth: true
        }
    }
}
