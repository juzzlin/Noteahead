...
ColumnLayout {
    ...
    StackLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    ComboBox {
                        ...
                        currentIndex: synthController.vco4LpfSlope
                        onActivated: idx => synthController.vco4LpfSlope = idx
                        Layout.fillWidth: true
                    }
                }
                ...
                ColumnLayout {
                    ...
                    ComboBox {
                        model: ["12 dB/oct", "24 dB/oct"]
                        currentIndex: synthController.vco4HpfSlope
                        onActivated: idx => synthController.vco4HpfSlope = idx
                        Layout.fillWidth: true
                    }
                }
            }
            ...
            FilterKnob {
                ...
                value: synthController.vco4LpfCutoff
                onMoved: v => synthController.vco4LpfCutoff = v
            ...
            Knob {
                ...
                value: synthController.vco4LpfResonance
                onMoved: v => synthController.vco4LpfResonance = v
                Layout.fillWidth: true
            }
            FilterKnob {
                label: qsTr("HPF Cutoff")
                controller: synthController
                value: synthController.vco4HpfCutoff
                isHpf: true
                onMoved: v => synthController.vco4HpfCutoff = v
                ToolTip.visible: hovered
    ...
    TabBar {
        ...
        TabButton {
            ...
            text: qsTr("Filter")
            font.bold: synthController.vco4FilterEngaged
        }
    }
}
