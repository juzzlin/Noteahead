...
AnimatedDialog {
    id: root
    title: applicationService.pianoSynthV3DeviceName
    modal: true
    focus: true
    ...
    onAboutToShow: () => {
        pianoSynthV3Controller.requestSettings();
    }
    ...
    footer: DialogButtonBox {
        AppButton {
            ...
            onClicked: pianoSynthV3Controller.reset()
        }
        AppButton {
            text: qsTr("Ok")
            implicitWidth: Constants.defaultButtonWidth
        ...
        onAccepted: () => {
            pianoSynthV3Controller.accept();
        }
        onRejected: () => {
            pianoSynthV3Controller.reject();
        }
    }
    ...
    ColumnLayout {
        ...
        VirtualKeyboard {
            Layout.fillWidth: true
            Layout.topMargin: 10
            onNoteOnRequested: note => pianoSynthV3Controller.playNote(note, UiService._activeVelocity / 127.0)
            onNoteOffRequested: note => pianoSynthV3Controller.stopNote(note)
        }
    }
}
