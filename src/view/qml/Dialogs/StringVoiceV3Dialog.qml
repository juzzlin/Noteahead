...
AnimatedDialog {
    id: root
    title: applicationService.stringVoiceV3DeviceName
    modal: true
    focus: true
    ...
    onAboutToShow: () => {
        stringVoiceV3Controller.requestSettings();
    }
    ...
    footer: DialogButtonBox {
        ...
        onAccepted: () => {
            stringVoiceV3Controller.accept();
        }
        onRejected: () => {
            stringVoiceV3Controller.reject();
        }
    }
    ...
    ColumnLayout {
        ...
        VirtualKeyboard {
            Layout.fillWidth: true
            Layout.topMargin: 10
            onNoteOnRequested: note => stringVoiceV3Controller.playNote(note, UiService._activeVelocity / 127.0)
            onNoteOffRequested: note => stringVoiceV3Controller.stopNote(note)
        }
    }
}
