...
EffectDialog {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ComboBox {
                model: effectRackController.compressorPresets()
                onActivated: index => effectRackController.applyCompressorPreset(root.effectIndex, index)
        ...
        ScrollView {
            ...
            RowLayout {
                width: parametersScrollView.availableWidth
                spacing: 30
